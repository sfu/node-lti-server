...
module.exports = function(config) {
    ...
    var canvasToken = config.canvas_token || '';
    ...
    exports.getAllOutlines = function(courses, ltiLaunchParameters) {
        var promises = [];
        courses.forEach(function(course) {
            ...
            request(url, function(err, response, body) {
                ...
                if (response.statusCode === 404 || (response.statusCode === 200 && body === '{}')) {
    ...
    exports.getCanvasProfilesForAllCourses = function(outlines) {
        var promises = [];
